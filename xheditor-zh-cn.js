...
$.xheditor=function(textarea,options)
{
	...
	this.uploadInit=function(jText,tourl,upext)
	{
		...
		{
			arrMsg=[];//重置消息队列
			var upload,fileList,filename,jUploadTip=$('<div style="margin:22px 0;text-align:center;line-height:30px;">文件上传中，请稍候……<br /></div>'),sLoading='<img src="'+skinPath+'img/loading.gif">';
			...
			else
			{
				...
				if(!upMultiple&&len>1){alert('请不要一次上传多个文件');return;}

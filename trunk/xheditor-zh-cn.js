...
var htmlAbout='<div style="width:200px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.0.0 beta2 build 100207</p><p>xhEditor是一个基于jQuery开发的跨平台开源迷你XHTML编辑器组件。</p><p><a href="http://xheditor.com/" target="_blank">http://xheditor.com/</a></p></div>';
	...
	this.uploadInit=function(jText,tourl,upext,setFunc)
	{
		...
		if(tourl.substr(0,1)=='!')//自定义上传管理页
		{
			jUpBtn.click(function(){
				...
				_this.showIframeModal(tourl.substr(1),'上传文件',setUploadUrl,null,null,function(){bShowPanel=true;});
			});
		}
		else
		{//系统默认ajax上传
